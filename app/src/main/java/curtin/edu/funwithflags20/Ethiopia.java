...
public class Ethiopia extends SQLiteOpenHelper
{
    private static final String DATABASENAME = "Ethiopia.db";
    private static final int  DATABASEVERSION = 1;
    private SQLiteDatabase sqLiteDatabase;

    public Ethiopia(Context context)
    {
    ...
    {
        Questions one = new Questions("What is the country code in Ethiopia?", "+251", "+263", "+27", "+257", "+44", "+251");
        Questions two = new Questions("How many months are in an Ethiopian year?", "13", "12", "24", "6", "14", "13");
        Questions three = new Questions("What is the biggest festival in Ethiopia?", "Timkat Festival", "Fez Festival of World Sacred Music", "FESPACO Film Festival", "Curee Salee and Wodaabe Gerewol", "Meskel Festival", "Timkat Festival");
        Questions four = new Questions("What does 'Addis Ababa' translate to?", "Great Favor", "New Beginnings", "New Flower", "Abundant Prosperity", "New Life", "New Flower");
        Questions five = new Questions("When was Ethiopia colonised?", "1842", "1914", "1888", "1805", "Never", "Never");
