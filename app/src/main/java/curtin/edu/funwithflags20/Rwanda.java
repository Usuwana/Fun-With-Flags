...
public class Rwanda extends SQLiteOpenHelper
{
    private static final String DATABASENAME = "Rwanda.db";
    private static final int  DATABASEVERSION = 1;
    private SQLiteDatabase sqLiteDatabase;

    public Rwanda(Context context)
    {
    ...
    {
        Questions one = new Questions("What is the percentage of women in Rwanda?", "27%", "64%", "50%", "83%", "17%", "64%");
        Questions two = new Questions("How safe has Rwanda being ranked as by the World Economic Forum?", "119", "56", "145", "3", "11", "11");
        Questions three = new Questions("Which country was Rwanda previously merged with?", "Burundi", "Kenya", "Namibia", "Zambia", "Ghana", "Burundi");
        Questions four = new Questions("What does Rwanda do once every month?", "Environmental Initiative", "Animal Rights Initiative", "Black History Day", "National Community Service Initiative", "National Rest Day", "National Community Service Initiative");
        Questions five = new Questions("What is one of Rwanda's fastest growing industries?", "Technology", "Mining", "Tourism", "Construction", "Agriculture", "Tourism");
        Questions six = new Questions("Which city in Rwanda is the cleanest city in Africa?", "Kigali", "Nyanza", "Addis Ababa", "Kamembe", "Gisenyi", "Kigali");
        Questions seven = new Questions("How many lakes are in Rwanda?", "23", "10", "24", "2", "25", "23");
        Questions eight = new Questions("How many national parks are in Rwanda?", "2", "1", "4", "12", "3", "3");
