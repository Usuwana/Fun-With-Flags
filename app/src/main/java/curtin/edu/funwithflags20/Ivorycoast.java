...
public class Ivorycoast extends SQLiteOpenHelper
{
    private static final String DATABASENAME = "IvoryCoast.db";
    private static final int  DATABASEVERSION = 1;
    private SQLiteDatabase sqLiteDatabase;

    public Ivorycoast(Context context)
    {
    ...
    {
        Questions one = new Questions("Who is the most famous footballer from Côte d'Ivoire?", "Samuel Eto'o", "Didier Drogba", "Jay Jay Okocha", "Sadio Mane", "Yaya Toure", "Didier Drogba");
        Questions two = new Questions("How many capital cities does Côte d'Ivoire have?", "1", "3", "2", "4", "0", "2");
        Questions three = new Questions("Which city in Côte d'Ivoire has the highest speaking French population in the world?", "Abidjan", "San-Pedro", "Man", "Paris", "Anyama", "Abidjan");
        Questions four = new Questions("What was Côte d'Ivoire formally known as?", "Ivory Coast", "Rhodesia", "Costa Do Marfim", "Guinea", "Gold Coast", "Ivory Coast");
        Questions five = new Questions("Côte d'Ivoire is the world's largest exporter of _________", "Gold", "Ivory", "Diamonds", "Cocoa", "Coffee", "Coffee");
